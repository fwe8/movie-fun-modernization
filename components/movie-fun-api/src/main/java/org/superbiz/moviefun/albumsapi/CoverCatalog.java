...
public class CoverCatalog {
    ...
    @HystrixCommand(fallbackMethod = "fallbackbuildDefaultCoverBlob")
    ...
    Blob fallbackbuildDefaultCoverBlob(long albumId) throws IOException {
        logger.warn("Calling getCover in Hystrix Fallback");
